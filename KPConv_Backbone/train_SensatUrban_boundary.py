...
import os
import sys
from datasets.SensatUrban_boundary import *
...
if __name__ == '__main__':
    ...
    training_dataset = SensatDataset(config, set='training', use_potentials=True)
    validation_dataset = SensatDataset(config, set='validation', use_potentials=True)
    training_sampler = SensatSampler(training_dataset)
    test_sampler = SensatSampler(validation_dataset)
    training_loader = DataLoader(training_dataset,
                                 batch_size=1,
                                 sampler=training_sampler,
                                 collate_fn=SensatCollate,
